...
ifneq ($(MM_SERVICESETTINGS_ENABLEDEVELOPER),)
	...
	cd server && env CGO_ENABLED=0 GOOS=freebsd GOARCH=amd64 $(GO) build $(GO_BUILD_FLAGS) -trimpath -o dist/plugin-freebsd-amd64;
endif
else
...
ifneq ($(MM_SERVICESETTINGS_ENABLEDEVELOPER),)
	...
	cd server && env CGO_ENABLED=0 GOOS=freebsd GOARCH=amd64 $(GO) build $(GO_BUILD_FLAGS) -gcflags "all=-N -l" -trimpath -o dist/plugin-freebsd-amd64;
endif
endif
endif
